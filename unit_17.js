...
function t2() {
	a2_res = a2.map(elem => { return elem ** 2 });
	return a2_res;
}
...
function t3() {
	a3_res = a3.map(elem => { return Number(elem) });
	return a3_res;
}
...
function t4() {
	a4_res = a4.filter(elem => { if (typeof elem == 'number') return true });
	return a4_res;
}
...
function t5() {
	a5_res = a5.filter(elem => {
		if (typeof elem === 'number' && elem % 2 === 0) return true;
	})
	return a5_res;
}
...
function t6() {
	a6_res = a6.filter(elem => {
		if (typeof elem === 'number' && elem > 14) return true;
	})
	return a6_res;
}
...
function t7() {
	a7_res = a7.map(elem => { return elem.toLowerCase() });
	return a7_res;
}
...
function t9() {
	let q = [];
	a9.forEach(elem => q.push(elem.toLowerCase()));
	a9 = q;
	return a9;
}
